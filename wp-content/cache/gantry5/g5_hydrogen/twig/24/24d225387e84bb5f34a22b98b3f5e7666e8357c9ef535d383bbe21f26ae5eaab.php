...
class __TwigTemplate_0b591b4671106b57ca3719eaa6223d8c009d841f4c3ec83bd18a45003e3281f3 extends \Twig\Template
{
...
";
        // line 3
        $context["class"] = ((("g-block " . call_user_func_array($this->env->getFilter('toGrid')->getCallable(), [$this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "size", [])])) . (($this->getAttribute($this->getAttribute(        // line 4
(isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "variations", [])) ? ((" " . twig_join_filter($this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "variations", []), " "))) : (""))) . (($this->getAttribute($this->getAttribute(        // line 5
(isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "class", [])) ? ((" " . twig_join_filter($this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "class", []), " "))) : ("")));
        // line 6
        echo "
";
        // line 7
        ...
        if (twig_trim_filter((isset($context["html"]) ? $context["html"] : null))) {
            // line 20
            echo "        <div ";
            if ($this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "id", [])) {
                echo "id=\"";
                echo $this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", []), "id", []);
                echo "\" ";
            }
            echo "class=\"";
...
";
    ...
    {
        return new Source("", "@nucleus/layout/block.html.twig", "/Applications/MAMP/htdocs/spiro_base_wp/wp-content/plugins/gantry5/engines/nucleus/templates/layout/block.html.twig");
    }
}
