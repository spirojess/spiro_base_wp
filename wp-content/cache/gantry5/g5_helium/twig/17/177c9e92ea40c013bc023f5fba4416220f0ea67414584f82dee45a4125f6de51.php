...
class __TwigTemplate_4835b26077ab84c575783d1bd8096ff576aa30686d927013e5b079c9b7a5e949 extends \Twig\Template
{
    ...
    ";
        // line 9
        if ( !twig_test_empty($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "link", []))) {
            echo "<a target=\"";
            echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "target", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "target", []), "_blank")) : ("_blank")));
            echo "\" href=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "link", []));
            echo "\" title=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "owner", []));
            echo "\">";
        }
        // line 10
        echo "        ";
    ...
    ";
        // line 14
        if ( !twig_test_empty($this->getAttribute($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "additional", []), "text", []))) {
            echo "<br />";
            echo $this->getAttribute($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "additional", []), "text", []);
        }
        // line 15
        echo "</div>
";
