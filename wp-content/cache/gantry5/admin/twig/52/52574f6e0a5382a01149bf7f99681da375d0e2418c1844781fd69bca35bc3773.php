...
class __TwigTemplate_6382dffc2035723bf93633441c7872791383a744f37f374d3d00eccec379305f extends \Twig\Template
{
...
<ul>
    ";
        ...
        foreach ($context['_seq'] as $context["index"] => $context["file"]) {
            ...
            echo "\"";
            echo ((($this->getAttribute($context["file"], "pathname", []) == (isset($context["value"]) ? $context["value"] : null))) ? (" class=\"selected\"") : (""));
            echo "
            title=\"";
            // line 35
...
(isset($context["bytes"]) ? $context["bytes"] : null) < (isset($context["terabyte"]) ? $context["terabyte"] : null))) {
    ...
    {
        return new Source("", "ajax/filepicker/files.html.twig", "/Applications/MAMP/htdocs/spiro_base_wp/wp-content/plugins/gantry5/admin/templates/ajax/filepicker/files.html.twig");
    }
}
