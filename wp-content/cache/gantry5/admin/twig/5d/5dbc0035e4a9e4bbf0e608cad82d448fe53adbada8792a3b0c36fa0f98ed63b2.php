...
class __TwigTemplate_83be950f3f3529c977e3a35651f90981cc8c4abdb2384ed70a4887e60b9dc264 extends \Twig\Template
{
    ...
    <option value=\"default\"
        ...
        // line 4
        echo "            data-data=\"";
        echo twig_escape_filter($this->env, twig_jsonencode_filter(["params" => ["navbar" => true], "url" => $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", [0 => "configurations/default", 1 => (((isset($context["configuration_page"]) || array_key_exists("configuration_page", $context))) ? (_twig_default_filter((isset($context["configuration_page"]) ? $context["configuration_page"] : null), "styles")) : ("styles"))], "method")]), "html_attr");
        echo "\">
        ";
        // line 5
...
";
        // line 9
        $context["user_conf"] = $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "outlines", []), "user", []);
        // line 10
        if ($this->getAttribute((isset($context["user_conf"]) ? $context["user_conf"] : null), "count", [])) {
            // line 11
            echo "    <optgroup label=\"";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["name"] => $context["title"]) {
                ...
                // line 19
                echo "                    data-data=\"";
                echo twig_escape_filter($this->env, twig_jsonencode_filter(["params" => ["navbar" => true], "url" => $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", [0 => "configurations", 1 => twig_escape_filter($this->env, $context["name"]), 2 => (((isset($context["configuration_page"]) || array_key_exists("configuration_page", $context))) ? (_twig_default_filter((isset($context["configuration_page"]) ? $context["configuration_page"] : null), "styles")) : ("styles"))], "method")]), "html_attr");
                echo "\"
            >
                ";
                // line 21
...
";
        // line 27
        $context["system_conf"] = $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "outlines", []), "system", []);
        // line 28
        if ($this->getAttribute((isset($context["system_conf"]) ? $context["system_conf"] : null), "count", [])) {
            // line 29
            echo "    <optgroup label=\"";
...
";
    ...
    {
        return new Source("", "partials/outlines-list.html.twig", "/Applications/MAMP/htdocs/spiro_base_wp/wp-content/plugins/gantry5/admin/templates/partials/outlines-list.html.twig");
    }
}
