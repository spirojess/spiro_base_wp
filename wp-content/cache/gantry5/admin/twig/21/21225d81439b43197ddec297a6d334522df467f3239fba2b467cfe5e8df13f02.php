...
class __TwigTemplate_99a9c73541d57bfde685045127a5a106731f57189992d7f88567b2e43560e6ff extends \Twig\Template
{
    ...
    {
        // line 1
        $context["updates"] = $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "platform", []), "updates", []);
        // line 2
        if ((isset($context["updates"]) ? $context["updates"] : null)) {
            // line 3
            $context["version"] = twig_last($this->env, twig_split_filter($this->env, $this->getAttribute((isset($context["updates"]) ? $context["updates"] : null), 0, []), " "));
            // line 4
    ...
    <div class=\"g-block\">
        <div class=\"update-header clearfix\">
            ...
            <div class=\"update-tools\">
                <a href=\"";
            // line 9
            echo $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "platform", []), "update", []);
...
";
    ...
    {
        return new Source("", "@gantry-admin/partials/updates.html.twig", "/Applications/MAMP/htdocs/spiro_base_wp/wp-content/plugins/gantry5/admin/templates/partials/updates.html.twig");
    }
}
