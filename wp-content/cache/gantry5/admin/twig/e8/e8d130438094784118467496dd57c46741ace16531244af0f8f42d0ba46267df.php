...
class __TwigTemplate_51a5d044659de5f24852a6f62790cec3d3110550fd5b534ce42b9af88c8a637e extends \Twig\Template
{
...
<div id=\"atoms\"";
    ...
    <ul class=\"atoms-picker\">";
        ...
        foreach ($context['_seq'] as $context["atom"] => $context["label"]) {
            ...
            data-atom-picked=\"";
            // line 9
            echo twig_escape_filter($this->env, twig_jsonencode_filter(["title" => $context["label"], "type" => $context["atom"], "attributes" => $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "config", []), "get", [0 => ("particles." . $context["atom"])], "method")]), "html_attr");
            echo "\"
        >
            ...
            <a href=\"";
            // line 13
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", [0 => "configurations", 1 => (isset($context["page_id"]) ? $context["page_id"] : null), 2 => "page", 3 => "atoms", 4 => $context["atom"]], "method"));
    ...
    <div class=\"card settings-block\">
        ";
        // line 21
        $context["list"] = ((($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => "page.head.atoms"], "method", true, true) &&  !(null === $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => "page.head.atoms"], "method")))) ? ($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => "page.head.atoms"], "method")) : ($this->getAttribute((isset($context["defaults"]) ? $context["defaults"] : null), "get", [0 => "page.head.atoms"], "method")));
        // line 22
        echo "        ";
...
(isset($context["gantry"]) ? $context["gantry"] : null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
                // line 28
                echo "                    ";
                ...
                echo "</span>
                        <a href=\"";
                // line 32
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", [0 => "configurations", 1 => (isset($context["page_id"]) ? $context["page_id"] : null), 2 => "page", 3 => "atoms", 4 => $this->getAttribute($context["atom"], "type", [])], "method"), "html", null, true);
                echo "\" class=\"atom-settings config-cog\">
        ...
        if ((isset($context["overrideable"]) ? $context["overrideable"] : null)) {
            ...
            // line 44
            echo "            ";
            $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/page/atoms.html.twig", 44)->display(twig_array_merge($context, ["scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "atoms", "has_value" =>  !(null === $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "atoms")], "method")), "field" => ["label" => "Enabled of the field Atoms"]]));
            // line 45
            echo "        ";
        }
        // line 46
    ...
    ";
        // line 49
        echo "    ";
        if ((( !(null === (isset($context["atoms_deprecated"]) ? $context["atoms_deprecated"] : null)) && twig_length_filter($this->env, (isset($context["atoms_deprecated"]) ? $context["atoms_deprecated"] : null))) && $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => "page.head.atoms"], "method"))) {
            // line 50
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "/Applications/MAMP/htdocs/spiro_base_wp/wp-content/plugins/gantry5/admin/templates/pages/configurations/page/atoms.html.twig");
    }
}
