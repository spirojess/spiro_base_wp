...
class __TwigTemplate_5e87c9625aa55c5cd7310e0cfaa45e3ed26c3fb2f2023ebd82b3baaa48af4bd5 extends \Twig\Template
{
        ...
        foreach ($context['_seq'] as $context["group"] => $context["list"]) {
            ...
            foreach ($context['_seq'] as $context["id"] => $context["item"]) {
                ...
                if ( !$this->getAttribute($context["item"], "hidden", [])) {
                    // line 31
                    echo "                                ";
                    $context["item"] = $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "content", []), "getBlueprintForm", [0 => (($context["group"] . "/") . $context["id"])], "method");
                    // line 32
                    echo "                                ";
                    $context["prefix"] = (((("content." . $context["group"]) . ".") . $context["id"]) . ".");
                    // line 33
                    echo "                                ";
                    $context["collapsed"] = ($this->getAttribute($this->getAttribute($context["item"], "form", []), "collapsed", []) || $this->getAttribute((isset($context["stored_data"]) ? $context["stored_data"] : null), (isset($context["prefix"]) ? $context["prefix"] : null)));
                    // line 34
                    echo "                                ";
                    ...
                    if ($this->getAttribute($this->getAttribute($this->getAttribute($context["item"], "form", []), "fields", []), "enabled", [])) {
                        // line 46
                        echo "                                            ";
                        $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/configurations/content/content.html.twig", 46)->display(twig_array_merge($context, ["default" => true, "scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "enabled", "field" => $this->getAttribute($this->getAttribute($this->getAttribute($context["item"], "form", []), "fields", []), "enabled", []), "value" => $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "enabled"), 1 => $this->getAttribute((isset($context["defaults"]) ? $context["defaults"] : null), "get", [0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "enabled")], "method")], "method")]));
                        // line 47
                        echo "
                                            ";
                        // line 48
                        if ((isset($context["overrideable"]) ? $context["overrideable"] : null)) {
                            // line 49
                            echo "                                                ";
                            $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/content/content.html.twig", 49)->display(twig_array_merge($context, ["scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "enabled", "has_value" =>  !(null === $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "enabled")], "method")), "field" => ["label" => (("Enabled of the " . $this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "name", [])) . " Particle")]]));
                            // line 50
                            echo "                                            ";
                        }
                        // line 51
                    ...
                    echo "                                    </h4>
                                    ...
                                    <div class=\"inner-params\">
                                        ";
                    // line 55
                    $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/configurations/content/content.html.twig", 55)->display(twig_array_merge($context, ["overrideable" => (isset($context["overrideable"]) ? $context["overrideable"] : null), "blueprints" => $this->getAttribute($context["item"], "form", []), "skip" => [0 => "enabled"], "prefix" => (isset($context["prefix"]) ? $context["prefix"] : null)]));
                    // line 56
                    echo "                                    </div>
                                </div>
                            ";
