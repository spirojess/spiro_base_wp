...
class __TwigTemplate_878bef7e4810747f4e67dc18958b322b6081ab7d5828f0342718f643f3fb2951 extends \Twig\Template
{
    ...
    public function block_gantry($context, array $blocks = [])
    {
        // line 4
        echo "    ";
        if (($this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "particles", []), "overrides", [0 => (isset($context["configuration"]) ? $context["configuration"] : null)], "method") || $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "request", []), "get", []), "get", [0 => "enable"], "method"))) {
            // line 5
            echo "    ";
                ...
                if (($context["list"] && ($context["group"] != "hidden"))) {
                    ...
                    foreach ($context['_seq'] as $context["id"] => $context["particle"]) {
                        ...
                        if ( !$this->getAttribute($context["particle"], "hidden", [])) {
                            // line 32
                            echo "                                ";
                            $context["particle"] = $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "particles", []), "getBlueprintForm", [0 => $context["id"]], "method");
                            // line 33
                            echo "                                ";
                            ...
                            if ($this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", []), "fields", []), "enabled", [])) {
                                // line 45
                                echo "                                            ";
                                $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/configurations/settings/settings.html.twig", 45)->display(twig_array_merge($context, ["default" => true, "scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "enabled", "field" => $this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", []), "fields", []), "enabled", []), "value" => $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "enabled")], "method")]));
                                // line 46
                                echo "
                                            ";
                                // line 47
                                if ((isset($context["overrideable"]) ? $context["overrideable"] : null)) {
                                    // line 48
                                    echo "                                                ";
                                    $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/settings/settings.html.twig", 48)->display(twig_array_merge($context, ["scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "enabled", "has_value" =>  !(null === $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "get", [0 => ((isset($context["prefix"]) ? $context["prefix"] : null) . "enabled")], "method")), "field" => ["label" => (("Enabled of the " . $this->getAttribute($context["particle"], "name", [])) . " Particle")]]));
                                    // line 49
                                    echo "                                            ";
                                }
                                // line 50
                            ...
                            echo "                                    </h4>
                                    ...
                                    <div class=\"inner-params\">
                                        ";
                            // line 54
                            $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/configurations/settings/settings.html.twig", 54)->display(twig_array_merge($context, ["ignore_not_overrideable" => true, "overrideable" => (isset($context["overrideable"]) ? $context["overrideable"] : null), "not_global_overrideable" => ($this->getAttribute($this->getAttribute($context["particle"], "form", []), "overrideable", []) === false), "blueprints" => $this->getAttribute($context["particle"], "form", []), "skip" => [0 => "enabled"], "data" => (isset($context["data"]) ? $context["data"] : null), "prefix" => (isset($context["prefix"]) ? $context["prefix"] : null)]));
                            // line 55
                            echo "                                    </div>
                                </div>
                            ";
        ...
        ";
            ...
            <p>";
            // line 74
            echo $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_PARTICLE_DEFAULTS_FROM_BASE", (isset($context["ajaxify"]) ? $context["ajaxify"] : null), $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", [0 => "configurations/default/settings"], "method"), $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_BASE_OUTLINE"));
            echo "</p>
            <p>";
            // line 75
            echo $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_PARTICLE_DEFAULTS_ENTER", (isset($context["ajaxify"]) ? $context["ajaxify"] : null), ($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", [0 => "configurations", 1 => (isset($context["configuration"]) ? $context["configuration"] : null), 2 => "settings"], "method") . "&enable=1"));
            echo "</p>
...
";
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/settings/settings.html.twig", "/Applications/MAMP/htdocs/spiro_base_wp/wp-content/plugins/gantry5/admin/templates/pages/configurations/settings/settings.html.twig");
    }
}
